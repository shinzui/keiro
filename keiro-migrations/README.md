...
`CODD_MIGRATION_DIRS` is still required by codd's settings parser, but Keiro
passes embedded migrations directly to codd. Production applications should run
the migration executable before startup and then open Kiroku with schema
