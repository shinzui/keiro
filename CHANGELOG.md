...
- Keep the external dependency cohort, migrations and DSL language unchanged.
  The upgrade blueprint includes a 0.16.0.0 → 0.17.0.0 edge for public error
  matching and rebuild/cutover refusal behavior.
- Include Git in the development shell and narrow release automation selection
  with refRegexes. Close prior timer-recovery requests with release evidence.
