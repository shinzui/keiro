...
in  S.Blueprint::{
    ...
    , migrations =
      ...
      , S.BlueprintMigration::{
        , from = "0.13.0.0"
        , to = "0.14.0.0"
        , prompt = ./migrations/0-13-to-0-14.md as Text
        }
      , S.BlueprintMigration::{
        , from = "0.14.0.0"
        , to = "0.15.0.0"
        , prompt = ./migrations/0-14-to-0-15.md as Text
        }
      , S.BlueprintMigration::{
        , from = "0.15.0.0"
        , to = "0.16.0.0"
        , prompt = ./migrations/0.15.0.0-to-0.16.0.0.md as Text
        }
      , S.BlueprintMigration::{
        , from = "0.16.0.0"
        , to = "0.17.0.0"
      ...
      , S.BlueprintMigration::{
        , from = "0.17.0.0"
        , to = "0.18.0.0"
        , prompt = ./migrations/0.17.0.0-to-0.18.0.0.md as Text
        }
      , S.BlueprintMigration::{
        , from = "0.18.0.0"
        , to = "0.19.0.0"
        , prompt = ./migrations/0.18.0.0-to-0.19.0.0.md as Text
        , entails =
          [ S.EntailedEdge::{
            , blueprint = "kiroku-upgrade"
            , from = "0.8.0.2"
