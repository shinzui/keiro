...
module Generated.IncidentPaging.Page.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-4cc963adc6662c5e") RequiredRejection GeneratedAuthoritative GuardNotApplicable PageDelivered "SendPage" Nothing Nothing [] 33
  , BehaviorRequirement (BehaviorKey "behavior-v1-d0a1ec215dcca5f8") LiveTransition GeneratedAuthoritative GuardTotal PagePending "SendPage" (Just (K.EdgeRef PagePending 0)) (Just PageDelivered) ["PageSent"] 38
  ]
