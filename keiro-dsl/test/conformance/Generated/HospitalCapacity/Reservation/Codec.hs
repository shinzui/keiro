...
import Generated.HospitalCapacity.Nominals (CommandId (..), DivertStatus (..), HospitalId (..), PatientAcuity (..), TransferReservationId (..), commandIdText, divertStatusText, hospitalIdText, patientAcuityText, transferReservationIdText)
        ...
        "TransferReservationCreated" ->
          TransferReservationCreated
            <$> ( TransferReservationCreatedData
                    <$> (TransferReservationId <$> o .: "reservationId")
