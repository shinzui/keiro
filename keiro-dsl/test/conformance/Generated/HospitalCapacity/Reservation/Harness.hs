...
sampleEventTransferReservationCreated = TransferReservationCreated (TransferReservationCreatedData sampleTransferReservationId sampleHospitalId sampleCommandId RedTag Open False)
