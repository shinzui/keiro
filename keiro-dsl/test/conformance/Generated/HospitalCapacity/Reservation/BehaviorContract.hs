...
-- @generated by keiro-dsl 0.10.0.0 (language keiro-dsl 4) from aggregate Reservation; do not edit.
...
behaviorRequirements =
  [ -- ReservationHeld x RequestTransferReservation: required rejection (spec line 20)
    BehaviorRequirement
      ...
      , requirementSource = ReservationHeld
      , requirementCommandName = "RequestTransferReservation"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
      , requirementLine = 20
      }
  , -- ReservationHeld x ConfirmReservation: live transition (spec line 32)
    BehaviorRequirement
      ...
      , requirementSource = ReservationHeld
      , requirementCommandName = "ConfirmReservation"
  ...
  , -- ReservationConfirmed x RequestTransferReservation: required rejection (spec line 20)
    BehaviorRequirement
      ...
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardNotApplicable
      , requirementSource = ReservationConfirmed
      , requirementCommandName = "RequestTransferReservation"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
  ...
  , -- ReservationUnrequested x RequestTransferReservation: live transition (spec line 28)
    BehaviorRequirement
      { requirementKey = BehaviorKey "behavior-v1-dff0853d3cd55550"
      , requirementKind = LiveTransition
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardUnknown
      , requirementSource = ReservationUnrequested
      , requirementCommandName = "RequestTransferReservation"
