...
module Generated.HospitalCapacity.Reservation.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-a544566ac00664fb") RequiredRejection GeneratedAuthoritative GuardNotApplicable ReservationHeld "RequestTransferReservation" Nothing Nothing [] 20
  , BehaviorRequirement (BehaviorKey "behavior-v1-bf9ebe70beb18440") LiveTransition GeneratedAuthoritative GuardTotal ReservationHeld "ConfirmReservation" (Just (K.EdgeRef ReservationHeld 0)) (Just ReservationConfirmed) ["TransferReservationConfirmed"] 32
  , BehaviorRequirement (BehaviorKey "behavior-v1-cf40a84edc844a41") RequiredRejection GeneratedAuthoritative GuardNotApplicable ReservationConfirmed "RequestTransferReservation" Nothing Nothing [] 20
  , BehaviorRequirement (BehaviorKey "behavior-v1-dff0853d3cd55550") LiveTransition GeneratedAuthoritative GuardUnknown ReservationUnrequested "RequestTransferReservation" (Just (K.EdgeRef ReservationUnrequested 0)) (Just ReservationHeld) ["TransferReservationCreated"] 28
  , BehaviorRequirement (BehaviorKey "behavior-v1-e53a65263ad89283") RequiredRejection GeneratedAuthoritative GuardNotApplicable ReservationConfirmed "ConfirmReservation" Nothing Nothing [] 20
  , BehaviorRequirement (BehaviorKey "behavior-v1-e7378f31cfa93bbf") RequiredRejection GeneratedAuthoritative GuardNotApplicable ReservationUnrequested "ConfirmReservation" Nothing Nothing [] 20
  ]
...
runAcceptance requirement seed command expectation = case expectation of
  ...
  NoOp -> case K.stepDetailedEither reservationTransducer seed command of
...
settleHistory requirement label history = do
  ...
  case K.applyEventsDetailedEither reservationTransducer (ReservationUnrequested, initialReservationRegs) decoded of
...
commandKind command = case command of
  RequestTransferReservation _ -> "RequestTransferReservation"
  ConfirmReservation _ -> "ConfirmReservation"
...
regsEqual left right = (left K.! #reservationId) == (right K.! #reservationId) && (left K.! #hospitalId) == (right K.! #hospitalId) && (left K.! #patientAcuity) == (right K.! #patientAcuity)
