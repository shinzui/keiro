...
-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 4) from aggregate ArtifactCatalog; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !ArtifactCatalogVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef ArtifactCatalogVertex))
  , target :: !(Maybe ArtifactCatalogVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | LiveWitness
      { key :: BehaviorKey
      , history :: [ArtifactCatalogEvent]
      , command :: ArtifactCatalogCommand
      , expected :: LiveExpectation
      }
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [ArtifactCatalogEvent]
      , observedChunk :: [ArtifactCatalogEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ArtifactCatalogEmpty x ObserveArtifact: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-5ef17e70af0d6ff7"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = ArtifactCatalogEmpty
      , commandName = "ObserveArtifact"
      , expectedEdge = (Just (K.EdgeRef ArtifactCatalogEmpty 0))
      , target = Just ArtifactCatalogObserved
      , eventKinds = ["ArtifactRecorded", "ArtifactAccepted"]
      }
  , -- ArtifactCatalogObserved x ObserveArtifact: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-c20f0b92a1f17333"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ArtifactCatalogObserved
      , commandName = "ObserveArtifact"
