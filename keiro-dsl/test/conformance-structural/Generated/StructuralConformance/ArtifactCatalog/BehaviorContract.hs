...
module Generated.StructuralConformance.ArtifactCatalog.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-5ef17e70af0d6ff7") LiveTransition GeneratedAuthoritative GuardTotal ArtifactCatalogEmpty "ObserveArtifact" (Just (K.EdgeRef ArtifactCatalogEmpty 0)) (Just ArtifactCatalogObserved) ["ArtifactRecorded", "ArtifactAccepted"] 80
  , BehaviorRequirement (BehaviorKey "behavior-v1-c20f0b92a1f17333") RequiredRejection GeneratedAuthoritative GuardNotApplicable ArtifactCatalogObserved "ObserveArtifact" Nothing Nothing [] 74
  ]
