...
import Generated.NominalScalars.NominalLedger.Codec (encodeNominalLedgerEvent, nominalLedgerCodec, parseNominalLedgerEvent)
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-274eaf83d346048a") LiveTransition GeneratedAuthoritative GuardUnknown NominalLedgerEmpty "RecordNominals" (Just (K.EdgeRef NominalLedgerEmpty 0)) (Just NominalLedgerRecorded) ["NominalsRecorded"] 84,
    BehaviorRequirement (BehaviorKey "behavior-v1-971c0c80ffdfe018") RequiredRejection GeneratedAuthoritative GuardNotApplicable NominalLedgerRecorded "RecordNominals" Nothing Nothing [] 76
  ]
