...
behaviorRequirements =
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-cf612b938b222e9f") LiveTransition HoleWitnessed GuardTotal NominalLedgerEmpty "RecordNominals" (Just (K.EdgeRef NominalLedgerEmpty 0)) (Just NominalLedgerRecorded) ["NominalsRecorded"] 87
  ]
