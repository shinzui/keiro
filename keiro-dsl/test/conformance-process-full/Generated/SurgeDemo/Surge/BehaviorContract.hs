...
module Generated.SurgeDemo.Surge.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-364cc8c97a1dccd7") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeFired "MarkSurgeTimerFired" Nothing Nothing [] 36
  , BehaviorRequirement (BehaviorKey "behavior-v1-7bd417bb60f14aea") LiveTransition GeneratedAuthoritative GuardTotal SurgeWatching "NoteSurgeThreshold" (Just (K.EdgeRef SurgeWatching 0)) (Just SurgeNoted) ["SurgeThresholdNoted"] 43
  , BehaviorRequirement (BehaviorKey "behavior-v1-8303777877a78d98") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeWatching "MarkSurgeTimerFired" Nothing Nothing [] 36
  , BehaviorRequirement (BehaviorKey "behavior-v1-9d1377f4e60cd45a") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeFired "NoteSurgeThreshold" Nothing Nothing [] 36
  , BehaviorRequirement (BehaviorKey "behavior-v1-c7783d8bb46678fe") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeNoted "NoteSurgeThreshold" Nothing Nothing [] 36
  , BehaviorRequirement (BehaviorKey "behavior-v1-db2fec76864e5867") LiveTransition GeneratedAuthoritative GuardTotal SurgeNoted "MarkSurgeTimerFired" (Just (K.EdgeRef SurgeNoted 0)) (Just SurgeFired) ["SurgeTimerFired"] 44
  ]
