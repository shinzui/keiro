...
module Generated.SurgeDemo.Hospital.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-4738b03b129c9778") LiveTransition GeneratedAuthoritative GuardTotal HospitalIdle "ActivateSurge" (Just (K.EdgeRef HospitalIdle 0)) (Just HospitalSurging) ["SurgeActivated"] 57
  , BehaviorRequirement (BehaviorKey "behavior-v1-8cc737e3759c26c7") RequiredRejection GeneratedAuthoritative GuardNotApplicable HospitalSurging "ActivateSurge" Nothing Nothing [] 52
  ]
