...
module Generated.Billing.Subscription.BehaviorContract where
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , requirementSource :: !SubscriptionVertex
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [SubscriptionEvent]
      , witnessCommand :: SubscriptionCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [SubscriptionEvent]
      , witnessObservedChunk :: [SubscriptionEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-09842123ac52dd63") RequiredRejection GeneratedAuthoritative GuardNotApplicable SubscriptionActive "ActivateSubscription" Nothing Nothing [] 12
  , BehaviorRequirement (BehaviorKey "behavior-v1-9399755ba2b617d6") LiveTransition GeneratedAuthoritative GuardUnknown SubscriptionInactive "ActivateSubscription" (Just (K.EdgeRef SubscriptionInactive 0)) (Just SubscriptionActive) ["SubscriptionActivated"] 20
  , BehaviorRequirement (BehaviorKey "behavior-v1-93f6f3f8cb36420d") RequiredRejection GeneratedAuthoritative GuardNotApplicable SubscriptionInactive "CancelSubscription" Nothing Nothing [] 12
  , BehaviorRequirement (BehaviorKey "behavior-v1-99ac0c974e512f76") RequiredRejection GeneratedAuthoritative GuardNotApplicable SubscriptionClosed "CancelSubscription" Nothing Nothing [] 12
  , BehaviorRequirement (BehaviorKey "behavior-v1-9b81e070774b3ae1") RequiredRejection GeneratedAuthoritative GuardNotApplicable SubscriptionClosed "ActivateSubscription" Nothing Nothing [] 12
  , BehaviorRequirement (BehaviorKey "behavior-v1-b5d1ca5d9ad9b2ec") LiveTransition GeneratedAuthoritative GuardTotal SubscriptionActive "CancelSubscription" (Just (K.EdgeRef SubscriptionActive 0)) (Just SubscriptionClosed) ["SubscriptionCancelled"] 24
  ]
