...
-- @generated by keiro-dsl 0.12.0.0 (language keiro-dsl 4) from aggregate Subscription; do not edit.
...
behaviorRequirements =
  [ -- SubscriptionActive x ActivateSubscription: required rejection
    BehaviorRequirement
      ...
      , requirementSource = SubscriptionActive
      , requirementCommandName = "ActivateSubscription"
  ...
  , -- SubscriptionInactive x ActivateSubscription: live transition
    BehaviorRequirement
      ...
      , requirementSource = SubscriptionInactive
      , requirementCommandName = "ActivateSubscription"
  ...
  , -- SubscriptionInactive x CancelSubscription: required rejection
    BehaviorRequirement
      ...
      , requirementGuardCoverage = GuardNotApplicable
      , requirementSource = SubscriptionInactive
      , requirementCommandName = "CancelSubscription"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
      }
  , -- SubscriptionClosed x CancelSubscription: required rejection
    BehaviorRequirement
      ...
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardNotApplicable
      , requirementSource = SubscriptionClosed
      , requirementCommandName = "CancelSubscription"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
