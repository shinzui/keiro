...
module Generated.ProcessReactionsMinimal.IncidentSaga.Harness (harnessAssertions) where
...
import Generated.ProcessReactionsMinimal.Nominals (IncidentId, parseIncidentId)
