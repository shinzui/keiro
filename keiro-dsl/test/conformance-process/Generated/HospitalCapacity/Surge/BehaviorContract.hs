...
module Generated.HospitalCapacity.Surge.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-5198a253324042e6") LiveTransition GeneratedAuthoritative GuardTotal SurgeIdle "NoteSurgeThreshold" (Just (K.EdgeRef SurgeIdle 0)) (Just SurgeIdle) ["SurgeThresholdNoted"] 44
  , BehaviorRequirement (BehaviorKey "behavior-v1-6721e0b61aa38780") LiveTransition GeneratedAuthoritative GuardTotal SurgeIdle "MarkSurgeTimerFired" (Just (K.EdgeRef SurgeIdle 1)) (Just SurgeIdle) ["SurgeTimerMarked"] 45
  ]
