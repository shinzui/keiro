...
module Generated.HospitalCapacity.Hospital.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-69ac3daa8569d350") LiveTransition GeneratedAuthoritative GuardTotal HospitalOperational "ActivateSurge" (Just (K.EdgeRef HospitalOperational 0)) (Just HospitalOperational) ["SurgeActivated"] 54
  ]
