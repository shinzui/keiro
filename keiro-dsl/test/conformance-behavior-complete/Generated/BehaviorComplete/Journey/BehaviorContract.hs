...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-0128e858fee6f2b3") ReplayTransition GeneratedAuthoritative GuardNotApplicable JourneyEmpty "LegacyStart" (Just (K.EdgeRef JourneyEmpty 2)) (Just JourneyActive) ["LegacyStarted"] 62
  , BehaviorRequirement (BehaviorKey "behavior-v1-08a2bda57424a16e") ReplayTransition GeneratedAuthoritative GuardNotApplicable JourneyEmpty "Start" (Just (K.EdgeRef JourneyEmpty 1)) (Just JourneyActive) ["Started"] 50
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-2f3ebf37a55781db") LiveTransition GeneratedAuthoritative GuardTotal JourneyActive "Decide" (Just (K.EdgeRef JourneyActive 0)) (Just JourneyActive) ["DecisionRecorded"] 44
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-68e75665b789892c") LiveTransition GeneratedAuthoritative GuardUnknown JourneyActive "Retire" (Just (K.EdgeRef JourneyActive 3)) (Just JourneyClosed) ["Retired", "RetirementAudited"] 70
  , BehaviorRequirement (BehaviorKey "behavior-v1-76005937ded24bec") RequiredRejection GeneratedAuthoritative GuardNotApplicable JourneyActive "LegacyStart" Nothing Nothing [] 21
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-8f79f2e40d8b3bd5") RequiredRejection GeneratedAuthoritative GuardNotApplicable JourneyEmpty "LegacyStart" Nothing Nothing [] 21
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-9c61af3593764622") RequiredRejection GeneratedAuthoritative GuardNotApplicable JourneyClosed "LegacyStart" Nothing Nothing [] 21
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-d2fc3eca5c449e84") LiveTransition GeneratedAuthoritative GuardUnknown JourneyEmpty "Start" (Just (K.EdgeRef JourneyEmpty 0)) (Just JourneyActive) ["Started"] 38
  , BehaviorRequirement (BehaviorKey "behavior-v1-db1a553baa3eda84") LiveTransition GeneratedAuthoritative GuardTotal JourneyActive "Decide" (Just (K.EdgeRef JourneyActive 1)) (Just JourneyActive) ["DecisionRecorded"] 56
  , BehaviorRequirement (BehaviorKey "behavior-v1-ea258e9c47d66aac") LiveTransition GeneratedAuthoritative GuardTotal JourneyActive "Ping" (Just (K.EdgeRef JourneyActive 2)) (Just JourneyActive) [] 67
  , BehaviorRequirement (BehaviorKey "behavior-v1-f0fbe3a3ba0b40e8") ReplayTransition GeneratedAuthoritative GuardNotApplicable JourneyActive "Retire" (Just (K.EdgeRef JourneyActive 4)) (Just JourneyClosed) ["Retired", "RetirementAudited"] 77
