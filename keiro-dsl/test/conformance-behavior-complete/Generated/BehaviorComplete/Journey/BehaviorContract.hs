...
-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 4) from aggregate Journey; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !JourneyVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef JourneyVertex))
  , target :: !(Maybe JourneyVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [JourneyEvent]
      , observedChunk :: [JourneyEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- JourneyEmpty x LegacyStart: replay-only transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-0128e858fee6f2b3"
      , kind = ReplayTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
      , commandName = "LegacyStart"
      , expectedEdge = (Just (K.EdgeRef JourneyEmpty 2))
      , target = Just JourneyActive
      , eventKinds = ["LegacyStarted"]
      }
  , -- JourneyEmpty x Start: replay-only transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-08a2bda57424a16e"
      , kind = ReplayTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
      , commandName = "Start"
      , expectedEdge = (Just (K.EdgeRef JourneyEmpty 1))
      , target = Just JourneyActive
      , eventKinds = ["Started"]
      }
  , -- JourneyClosed x Ping: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-2e1fd6b9580e1a3d"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyClosed
      , commandName = "Ping"
  ...
  , -- JourneyActive x Decide: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-2f3ebf37a55781db"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = JourneyActive
      , commandName = "Decide"
      , expectedEdge = (Just (K.EdgeRef JourneyActive 0))
      , target = Just JourneyActive
      , eventKinds = ["DecisionRecorded"]
      }
  , -- JourneyActive x Start: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-43b8fc7fa48595dd"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyActive
  ...
  , -- JourneyActive x Retire: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-68e75665b789892c"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardUnknown
      , source = JourneyActive
      , commandName = "Retire"
      , expectedEdge = (Just (K.EdgeRef JourneyActive 3))
      , target = Just JourneyClosed
      , eventKinds = ["Retired", "RetirementAudited"]
      }
  , -- JourneyActive x LegacyStart: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-76005937ded24bec"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyActive
  ...
  , -- JourneyClosed x Decide: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-7ea811586a738ee5"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyClosed
  ...
  , -- JourneyEmpty x Ping: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-83b0a46823e1a788"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
  ...
  , -- JourneyEmpty x LegacyStart: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-8f79f2e40d8b3bd5"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
  ...
  , -- JourneyEmpty x Retire: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-926739ffb27d20e7"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
  ...
  , -- JourneyClosed x LegacyStart: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-9c61af3593764622"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyClosed
  ...
  , -- JourneyEmpty x Decide: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-ba7053f86d15e1b0"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyEmpty
  ...
  , -- JourneyClosed x Start: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-be8b08a049ab4d8b"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyClosed
  ...
  , -- JourneyEmpty x Start: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-d2fc3eca5c449e84"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardUnknown
      , source = JourneyEmpty
      , commandName = "Start"
      , expectedEdge = (Just (K.EdgeRef JourneyEmpty 0))
      , target = Just JourneyActive
      , eventKinds = ["Started"]
      }
  , -- JourneyActive x Decide: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-db1a553baa3eda84"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = JourneyActive
      , commandName = "Decide"
      , expectedEdge = (Just (K.EdgeRef JourneyActive 1))
      , target = Just JourneyActive
      , eventKinds = ["DecisionRecorded"]
      }
  , -- JourneyActive x Ping: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-ea258e9c47d66aac"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = JourneyActive
      , commandName = "Ping"
      , expectedEdge = (Just (K.EdgeRef JourneyActive 2))
      , target = Just JourneyActive
      , eventKinds = []
      }
  , -- JourneyActive x Retire: replay-only transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-f0fbe3a3ba0b40e8"
      , kind = ReplayTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyActive
      , commandName = "Retire"
      , expectedEdge = (Just (K.EdgeRef JourneyActive 4))
      , target = Just JourneyClosed
      , eventKinds = ["Retired", "RetirementAudited"]
      }
  , -- JourneyClosed x Retire: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-f9cae2bf4c0d0562"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = JourneyClosed
