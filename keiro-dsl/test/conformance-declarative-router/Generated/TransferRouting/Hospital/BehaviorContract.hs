...
-- @generated by keiro-dsl 0.15.0.0 (language keiro-dsl 5) from aggregate Hospital; do not edit.
...
behaviorRequirements =
  [ -- HospitalRouted x RouteAcceptedTransferNeed: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-51a443ca8bbb0eab"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = HospitalRouted
      , commandName = "RouteAcceptedTransferNeed"
  ...
  , -- HospitalOpen x RouteAcceptedTransferNeed: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-6dc56a81dec7fe2b"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = HospitalOpen
      , commandName = "RouteAcceptedTransferNeed"
      , expectedEdge = (Just (K.EdgeRef HospitalOpen 0))
      , target = Just HospitalRouted
      , eventKinds = ["TransferNeedRouted"]
      }
  ]
