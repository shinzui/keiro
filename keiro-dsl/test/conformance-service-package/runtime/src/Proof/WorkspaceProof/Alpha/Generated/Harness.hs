...
sampleEventAlphaPinged = (AlphaPinged (AlphaPingedData (case parseProofId "proof_01h455vb4pex5vsknk084sn02q" of Right parsed -> parsed; Left _ -> error "generated valid ID sample failed to parse")))

acceptPingAlpha :: Bool
acceptPingAlpha =
  case step alphaTransducer (AlphaActive, initialAlphaRegs) ((PingAlpha (PingAlphaData (case parseProofId "proof_01h455vb4pex5vsknk084sn02q" of Right parsed -> parsed; Left _ -> error "generated valid ID sample failed to parse")))) of
