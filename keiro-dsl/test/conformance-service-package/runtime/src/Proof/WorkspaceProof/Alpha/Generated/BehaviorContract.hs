...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-e2c1eef1cb7848f5") LiveTransition GeneratedAuthoritative GuardTotal AlphaActive "PingAlpha" (Just (K.EdgeRef AlphaActive 0)) (Just AlphaActive) ["AlphaPinged"] 11
  ]
