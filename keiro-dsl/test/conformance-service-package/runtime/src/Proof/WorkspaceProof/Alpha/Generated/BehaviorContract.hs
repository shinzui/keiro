...
module Proof.WorkspaceProof.Alpha.Generated.BehaviorContract where
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [AlphaEvent]
      , witnessCommand :: AlphaCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [AlphaEvent]
      , witnessObservedChunk :: [AlphaEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-579df4e5e81f7729") ReplayTransition GeneratedAuthoritative GuardNotApplicable AlphaActive "LegacyPingAlpha" (Just (K.EdgeRef AlphaActive 2)) (Just AlphaActive) ["LegacyAlphaPinged"] 15
  , BehaviorRequirement (BehaviorKey "behavior-v1-72a96c964b44a2b6") ReplayTransition GeneratedAuthoritative GuardNotApplicable AlphaActive "PingAlpha" (Just (K.EdgeRef AlphaActive 1)) (Just AlphaActive) ["AlphaPinged"] 14
  , BehaviorRequirement (BehaviorKey "behavior-v1-baf43b4c31db955a") LiveTransition GeneratedAuthoritative GuardUnknown AlphaActive "PingAlpha" (Just (K.EdgeRef AlphaActive 0)) (Just AlphaActive) ["AlphaPinged"] 13
  , BehaviorRequirement (BehaviorKey "behavior-v1-c062ccf5e9b6f5c4") RequiredRejection GeneratedAuthoritative GuardNotApplicable AlphaActive "LegacyPingAlpha" Nothing Nothing [] 6
  ]
