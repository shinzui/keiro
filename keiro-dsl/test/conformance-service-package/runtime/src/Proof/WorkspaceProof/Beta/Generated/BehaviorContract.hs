...
module Proof.WorkspaceProof.Beta.Generated.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-6ab7fee2c8aa4e1d") LiveTransition GeneratedAuthoritative GuardTotal BetaActive "PingBeta" (Just (K.EdgeRef BetaActive 0)) (Just BetaActive) ["BetaPinged"] 28
  ]
