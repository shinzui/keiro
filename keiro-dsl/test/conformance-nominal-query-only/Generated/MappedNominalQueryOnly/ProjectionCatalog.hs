-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 6) from projection-catalog mapped-nominal-query-only; do not edit.
...
import MappedNominalQueryOnly.ProjectionCatalog.ProjectionCatalogHoles qualified as Holes
import Generated.MappedNominalQueryOnly.TemplateLookup.ReadModel qualified as RMTemplateLookup
