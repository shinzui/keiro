...
data BehaviorRequirement = BehaviorRequirement
  ...
  , requirementSource :: !ScalarAccountVertex
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [ScalarAccountEvent]
      , witnessCommand :: ScalarAccountCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [ScalarAccountEvent]
      , witnessObservedChunk :: [ScalarAccountEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ScalarAccountOpen x Close: required rejection
    BehaviorRequirement
      ...
      , requirementSource = ScalarAccountOpen
      , requirementCommandName = "Close"
  ...
  , -- ScalarAccountReviewed x Adjust: required rejection
    BehaviorRequirement
      ...
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardNotApplicable
      , requirementSource = ScalarAccountReviewed
      , requirementCommandName = "Adjust"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
      }
  , -- ScalarAccountClosed x Adjust: required rejection
    BehaviorRequirement
      ...
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardNotApplicable
      , requirementSource = ScalarAccountClosed
      , requirementCommandName = "Adjust"
      , requirementExpectedEdge = Nothing
      , requirementTarget = Nothing
      , requirementEventKinds = []
  ...
  , -- ScalarAccountReviewed x Close: live transition
    BehaviorRequirement
      ...
      , requirementEvidence = HoleWitnessed
