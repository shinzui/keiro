...
behaviorRequirements =
  [ -- ProjectArchived x ArchiveProject: required rejection
    BehaviorRequirement
      ...
      , requirementSource = ProjectArchived
      , requirementCommandName = "ArchiveProject"
  ...
  , -- ProjectEmpty x RegisterProject: live transition
    BehaviorRequirement
      ...
      , requirementSource = ProjectEmpty
      , requirementCommandName = "RegisterProject"
