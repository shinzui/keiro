...
-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 4) from aggregate Project; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !ProjectVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef ProjectVertex))
  , target :: !(Maybe ProjectVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [ProjectEvent]
      , observedChunk :: [ProjectEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ProjectArchived x ArchiveProject: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-3de05f6aced1fbd8"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ProjectArchived
      , commandName = "ArchiveProject"
  ...
  , -- ProjectEmpty x RegisterProject: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-3ef04b25c79aa821"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardUnknown
      , source = ProjectEmpty
      , commandName = "RegisterProject"
      , expectedEdge = (Just (K.EdgeRef ProjectEmpty 0))
      , target = Just ProjectLive
      , eventKinds = ["ProjectRegistered"]
      }
  , -- ProjectArchived x RegisterProject: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-44c09c629d21fd17"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ProjectArchived
  ...
  , -- ProjectLive x RegisterProject: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-6134478c9aaa78cb"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ProjectLive
  ...
  , -- ProjectEmpty x ArchiveProject: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-c4b406a5be4a0d0b"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ProjectEmpty
  ...
  , -- ProjectLive x ArchiveProject: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-ea703ecdfbda1e70"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardUnknown
      , source = ProjectLive
      , commandName = "ArchiveProject"
      , expectedEdge = (Just (K.EdgeRef ProjectLive 0))
      , target = Just ProjectArchived
      , eventKinds = ["ArchivalRecorded"]
      }
  ]
...
runRejection :: BehaviorRequirement -> (ProjectVertex, K.RegFile ProjectRegs) -> ProjectCommand -> LiveExpectation -> Either BehaviorFailure ()
...
runAcceptance :: BehaviorRequirement -> (ProjectVertex, K.RegFile ProjectRegs) -> ProjectCommand -> LiveExpectation -> Either BehaviorFailure ()
...
checkAcceptedEnvelope :: BehaviorRequirement -> K.StepSuccess ProjectRegs ProjectVertex ProjectEvent -> Either BehaviorFailure ()
...
checkSingleAttribution :: BehaviorRequirement -> K.EdgeMode -> Int -> [K.ReplayAttribution ProjectVertex] -> Either BehaviorFailure ()
...
settleHistory :: BehaviorRequirement -> Text -> [ProjectEvent] -> Either BehaviorFailure (K.ReplaySuccess ProjectRegs ProjectVertex)
