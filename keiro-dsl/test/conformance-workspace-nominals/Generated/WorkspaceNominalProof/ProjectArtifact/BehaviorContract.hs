...
data BehaviorRequirement = BehaviorRequirement
  ...
  , requirementSource :: !ProjectArtifactVertex
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [ProjectArtifactEvent]
      , witnessCommand :: ProjectArtifactCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [ProjectArtifactEvent]
      , witnessObservedChunk :: [ProjectArtifactEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ProjectArtifactRecorded x RecordArtifact: required rejection
    BehaviorRequirement
      ...
      , requirementSource = ProjectArtifactRecorded
      , requirementCommandName = "RecordArtifact"
  ...
  , -- ProjectArtifactEmpty x RecordArtifact: live transition
    BehaviorRequirement
      ...
      , requirementSource = ProjectArtifactEmpty
      , requirementCommandName = "RecordArtifact"
