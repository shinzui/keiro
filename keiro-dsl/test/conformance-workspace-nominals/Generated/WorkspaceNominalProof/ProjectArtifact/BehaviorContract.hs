...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-11da0fd14ad66aa0") RequiredRejection GeneratedAuthoritative GuardNotApplicable ProjectArtifactRecorded "RecordArtifact" Nothing Nothing [] 8,
    BehaviorRequirement (BehaviorKey "behavior-v1-c6d79387e567590e") LiveTransition GeneratedAuthoritative GuardUnknown ProjectArtifactEmpty "RecordArtifact" (Just (K.EdgeRef ProjectArtifactEmpty 0)) (Just ProjectArtifactRecorded) ["ArtifactRecorded"] 13
  ]
