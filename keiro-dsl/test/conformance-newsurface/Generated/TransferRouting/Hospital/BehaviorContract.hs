...
module Generated.TransferRouting.Hospital.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-8c1612ae6464bb11") LiveTransition GeneratedAuthoritative GuardTotal HospitalAccepting "RouteAcceptedTransferNeed" (Just (K.EdgeRef HospitalAccepting 0)) (Just HospitalAccepting) ["AcceptedTransferNeedRouted"] 39
  ]
