-- @generated by keiro-dsl 0.14.0.0 (language keiro-dsl 4) from context transfer-routing behavior source map; do not edit.
...
behaviorSourceLocation key = case key of
  "behavior-v1-8c1612ae6464bb11" -> Just (BehaviorSourceLocation "keiro-dsl/test/fixtures/transfer-routing.keiro" 39 3)
  _ -> Nothing
