...
module Generated.ReplayDivergence.Note.BehaviorContract where
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [NoteEvent]
      , witnessCommand :: NoteCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [NoteEvent]
      , witnessObservedChunk :: [NoteEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-248e9c1b1eb3e5bc") LiveTransition GeneratedAuthoritative GuardTotal NoteEmpty "WriteNote" (Just (K.EdgeRef NoteEmpty 0)) (Just NoteRecorded) ["NoteWritten"] 12
  , BehaviorRequirement (BehaviorKey "behavior-v1-7c36eda198514110") RequiredRejection GeneratedAuthoritative GuardNotApplicable NoteRecorded "WriteNote" Nothing Nothing [] 7
  ]
