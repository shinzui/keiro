...
-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 5) from aggregate Orders; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !OrdersVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef OrdersVertex))
  , target :: !(Maybe OrdersVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [OrdersEvent]
      , observedChunk :: [OrdersEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- OrdersEmpty x RecordOrder: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-8861ebe94ff5f68a"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = OrdersEmpty
      , commandName = "RecordOrder"
      , expectedEdge = (Just (K.EdgeRef OrdersEmpty 0))
      , target = Just OrdersRecorded
      , eventKinds = ["OrderRecorded"]
      }
  , -- OrdersRecorded x RecordOrder: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-badd7ebab3a3a844"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = OrdersRecorded
      , commandName = "RecordOrder"
