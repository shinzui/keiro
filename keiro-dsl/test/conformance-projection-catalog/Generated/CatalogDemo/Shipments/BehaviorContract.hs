...
-- @generated by keiro-dsl 0.15.0.0 (language keiro-dsl 5) from aggregate Shipments; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !ShipmentsVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef ShipmentsVertex))
  , target :: !(Maybe ShipmentsVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | LiveWitness
      { key :: BehaviorKey
      , history :: [ShipmentsEvent]
      , command :: ShipmentsCommand
      , expected :: LiveExpectation
      }
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [ShipmentsEvent]
      , observedChunk :: [ShipmentsEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ShipmentsRecorded x RecordShipment: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-89eeb23ded471fe8"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ShipmentsRecorded
      , commandName = "RecordShipment"
  ...
  , -- ShipmentsEmpty x RecordShipment: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-b0a7e39ecba10454"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = ShipmentsEmpty
      , commandName = "RecordShipment"
      , expectedEdge = (Just (K.EdgeRef ShipmentsEmpty 0))
      , target = Just ShipmentsRecorded
      , eventKinds = ["ShipmentRecorded"]
      }
  ]
