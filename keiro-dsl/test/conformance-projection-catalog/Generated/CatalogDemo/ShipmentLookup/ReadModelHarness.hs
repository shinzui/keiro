...
readModelFacts =
  ...
  , ("freshness", "Immediate", show (readModelDefaultFreshness shipmentLookupReadModel))
  , ("cursorAuthority", "NoQueryCursor", show (readModelCursorAuthority shipmentLookupReadModel))
  ]
