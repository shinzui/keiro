...
-- @generated by keiro-dsl 0.10.0.0 (language keiro-dsl 4) from aggregate ScalarLedger; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , requirementSource :: !ScalarLedgerVertex
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [ScalarLedgerEvent]
      , witnessCommand :: ScalarLedgerCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [ScalarLedgerEvent]
      , witnessObservedChunk :: [ScalarLedgerEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ScalarLedgerEmpty x Record: live transition (spec line 28)
    BehaviorRequirement
      ...
      , requirementSource = ScalarLedgerEmpty
      , requirementCommandName = "Record"
  ...
  , -- ScalarLedgerRecorded x Record: required rejection (spec line 8)
    BehaviorRequirement
      ...
      , requirementSource = ScalarLedgerRecorded
      , requirementCommandName = "Record"
