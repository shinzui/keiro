...
module Generated.AggregateScalars.ScalarLedger.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-4e461a9ba9271054") LiveTransition GeneratedAuthoritative GuardUnknown ScalarLedgerEmpty "Record" (Just (K.EdgeRef ScalarLedgerEmpty 0)) (Just ScalarLedgerRecorded) ["ScalarsRecorded"] 28
  , BehaviorRequirement (BehaviorKey "behavior-v1-d15e326edfa1a438") RequiredRejection GeneratedAuthoritative GuardNotApplicable ScalarLedgerRecorded "Record" Nothing Nothing [] 8
  ]
