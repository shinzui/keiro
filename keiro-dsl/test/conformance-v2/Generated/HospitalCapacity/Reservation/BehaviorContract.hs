...
-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 4) from aggregate Reservation; do not edit.
...
data BehaviorRequirement = BehaviorRequirement
  ...
  , source :: !ReservationVertex
  , commandName :: !Text
  , expectedEdge :: !(Maybe (K.EdgeRef ReservationVertex))
  , target :: !(Maybe ReservationVertex)
  , eventKinds :: ![Text]
  }
...
data BehaviorWitness
  ...
  | ReplayWitness
      { key :: BehaviorKey
      , historyPrefix :: [ReservationEvent]
      , observedChunk :: [ReservationEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ -- ReservationUnrequested x RequestTransferReservation: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-25971c9701fc5660"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardUnknown
      , source = ReservationUnrequested
      , commandName = "RequestTransferReservation"
      , expectedEdge = (Just (K.EdgeRef ReservationUnrequested 0))
      , target = Just ReservationHeld
      , eventKinds = ["TransferReservationCreated"]
      }
  , -- ReservationHeld x RequestTransferReservation: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-a544566ac00664fb"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ReservationHeld
      , commandName = "RequestTransferReservation"
  ...
  , -- ReservationHeld x ConfirmReservation: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-bf9ebe70beb18440"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = ReservationHeld
      , commandName = "ConfirmReservation"
      , expectedEdge = (Just (K.EdgeRef ReservationHeld 0))
      , target = Just ReservationConfirmed
      , eventKinds = ["TransferReservationConfirmed"]
      }
  , -- ReservationConfirmed x RequestTransferReservation: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-cf40a84edc844a41"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ReservationConfirmed
      , commandName = "RequestTransferReservation"
      , expectedEdge = Nothing
      , target = Nothing
      , eventKinds = []
  ...
  , -- ReservationConfirmed x ConfirmReservation: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-e53a65263ad89283"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ReservationConfirmed
  ...
  , -- ReservationUnrequested x ConfirmReservation: required rejection
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-e7378f31cfa93bbf"
      , kind = RequiredRejection
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardNotApplicable
      , source = ReservationUnrequested
