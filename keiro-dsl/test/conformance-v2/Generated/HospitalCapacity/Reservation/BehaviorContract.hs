...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-25971c9701fc5660") LiveTransition GeneratedAuthoritative GuardUnknown ReservationUnrequested "RequestTransferReservation" (Just (K.EdgeRef ReservationUnrequested 0)) (Just ReservationHeld) ["TransferReservationCreated"] 29
  ...
  , BehaviorRequirement (BehaviorKey "behavior-v1-bf9ebe70beb18440") LiveTransition GeneratedAuthoritative GuardTotal ReservationHeld "ConfirmReservation" (Just (K.EdgeRef ReservationHeld 0)) (Just ReservationConfirmed) ["TransferReservationConfirmed"] 33
