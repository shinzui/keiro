...
behaviorRequirements =
  ...
  , -- PagePending x SendPage: live transition (spec line 24)
    BehaviorRequirement
      { requirementKey = BehaviorKey "behavior-v1-75972c0c000e2777"
      , requirementKind = LiveTransition
      , requirementEvidence = GeneratedAuthoritative
      , requirementGuardCoverage = GuardTotal
      , requirementSource = PagePending
      , requirementCommandName = "SendPage"
