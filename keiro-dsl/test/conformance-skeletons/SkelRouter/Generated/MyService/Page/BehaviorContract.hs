...
module SkelRouter.Generated.MyService.Page.BehaviorContract where
...
data BehaviorWitness
  ...
  | LiveWitness
      ...
      , witnessHistory :: [PageEvent]
      , witnessCommand :: PageCommand
      , witnessExpected :: LiveExpectation
      }
  | ReplayWitness
      { witnessKey :: BehaviorKey
      , witnessHistoryPrefix :: [PageEvent]
      , witnessObservedChunk :: [PageEvent]
      }
  deriving stock (Eq, Show)
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-333c07acc3005e8f") RequiredRejection GeneratedAuthoritative GuardNotApplicable PageDelivered "SendPage" Nothing Nothing [] 19
  , BehaviorRequirement (BehaviorKey "behavior-v1-75972c0c000e2777") LiveTransition GeneratedAuthoritative GuardTotal PagePending "SendPage" (Just (K.EdgeRef PagePending 0)) (Just PageDelivered) ["PageSent"] 24
  ]
