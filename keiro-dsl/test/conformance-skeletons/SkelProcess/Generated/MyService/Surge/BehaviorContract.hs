...
module SkelProcess.Generated.MyService.Surge.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-86bc21fdc4a8ca5d") LiveTransition GeneratedAuthoritative GuardTotal SurgeIdle "NoteSurgeThreshold" (Just (K.EdgeRef SurgeIdle 0)) (Just SurgeIdle) ["SurgeThresholdNoted"] 43
  , BehaviorRequirement (BehaviorKey "behavior-v1-86bd3f785d9c7719") LiveTransition GeneratedAuthoritative GuardTotal SurgeIdle "MarkSurgeTimerFired" (Just (K.EdgeRef SurgeIdle 1)) (Just SurgeFired) ["SurgeTimerMarked"] 44
  , BehaviorRequirement (BehaviorKey "behavior-v1-d517bd7075620508") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeFired "NoteSurgeThreshold" Nothing Nothing [] 37
  , BehaviorRequirement (BehaviorKey "behavior-v1-fe2793e47f0b6989") RequiredRejection GeneratedAuthoritative GuardNotApplicable SurgeFired "MarkSurgeTimerFired" Nothing Nothing [] 37
  ]
