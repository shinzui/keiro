...
module SkelProcess.Generated.MyService.Hospital.BehaviorContract where
...
behaviorRequirements =
  [ BehaviorRequirement (BehaviorKey "behavior-v1-01e61eb25214eb69") RequiredRejection GeneratedAuthoritative GuardNotApplicable HospitalSurging "ActivateSurge" Nothing Nothing [] 48
  , BehaviorRequirement (BehaviorKey "behavior-v1-e093b54ae670c60c") LiveTransition GeneratedAuthoritative GuardTotal HospitalOperational "ActivateSurge" (Just (K.EdgeRef HospitalOperational 0)) (Just HospitalSurging) ["SurgeActivated"] 52
  ]
