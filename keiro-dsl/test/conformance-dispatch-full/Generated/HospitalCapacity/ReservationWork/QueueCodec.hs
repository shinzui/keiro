-- @generated by keiro-dsl 0.11.0.0 (language keiro-dsl 4) from workqueue reservation_work; do not edit.
...
module Generated.HospitalCapacity.ReservationWork.QueueCodec (reservationWorkPayloadCodec, reservationWorkJobCodec) where

import Data.List.NonEmpty (NonEmpty (..))
import Keiro.Codec (Codec (..), EventType (..))
import Keiro.PGMQ.Codec (JobCodec, keiroJobCodec)
import Generated.HospitalCapacity.ReservationWork.Queue (ReservationWorkItem, encodeReservationWorkItem, parseReservationWorkItem)
