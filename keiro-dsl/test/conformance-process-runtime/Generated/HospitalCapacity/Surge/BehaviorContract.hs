-- @generated by keiro-dsl 0.16.0.0 (language keiro-dsl 4) from aggregate Surge; do not edit.
...
behaviorRequirements =
  [ -- SurgeIdle x NoteSurgeThreshold: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-5198a253324042e6"
      , kind = LiveTransition
  ...
  , -- SurgeIdle x MarkSurgeTimerFired: live transition
    BehaviorRequirement
      { key = BehaviorKey "behavior-v1-6721e0b61aa38780"
      , kind = LiveTransition
      , evidence = GeneratedAuthoritative
      , guardCoverage = GuardTotal
      , source = SurgeIdle
