...
| 193 | Surface the effective language contract and enforce warnings in CI | docs/plans/193-surface-the-effective-language-contract-and-enforce-warnings-in-ci.md | None | None | In Progress |
...
- [ ] EP-193 M4: Docs, CI recipe, warning-policy ratification, ADR 0004 amendment, changelogs
