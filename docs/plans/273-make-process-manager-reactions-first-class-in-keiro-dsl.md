...
- [ ] (2026-09-16 01:10Z) M3 in progress: the timer-free generator, typed create-once decoder hole, manager and worker wrapper are implemented, and the PostgreSQL conformance proves acceptance, acknowledged redelivery, one saga append, one target append, and the public duplicate result; the clean-tree corpus-policy gate remains before completion.
