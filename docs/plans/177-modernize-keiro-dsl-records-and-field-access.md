...
- Observation: The checked Milestone 1 inventories found fewer package fields but more generated
  ...
  Evidence: `python3 scripts/generate-record-migration-manifests.py --check` accounts for 273
  package record-owning declarations with 1,389 fields, including 1,363 strict fields and 1,293
  fields exported through an exposed module's `Type (..)`. The generated edition inventory covers
  487 overwriteable modules, 289 record declarations, 1,416 fields, 8,534 lexical field-label
