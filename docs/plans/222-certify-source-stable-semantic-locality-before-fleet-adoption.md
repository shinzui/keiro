...
`scripts/check-conformance-corpus.sh`. It represents 41 public CLI invocations and all generated
conformance suites declared in `keiro-dsl/keiro-dsl.cabal`. [Plan 196](196-polish-generated-conformance-output-for-maintainers.md)
