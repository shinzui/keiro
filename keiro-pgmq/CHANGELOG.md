...
- No user-facing changes; release in lockstep with the Keiro 0.17.0.0 package set.
...
Released with the package set for the `keiro-dsl` 0.9.0.0 work.
...
No user-facing changes beyond the lockstep `keiro-core ^>=0.7.0.0` bound.
Released with the package set for the `keiro-dsl` 0.7.0.0 work.

## 0.6.0.0 — 2026-07-31

No user-facing changes beyond the lockstep `keiro-core ^>=0.6.0.0` bound.
Released with the package set for the `keiro-dsl` 0.6.0.0 work.
